...
import { loginAction, loginWithGoogle, loginWithGitHub, AuthState } from '@/lib/actions/auth'
    ...
    <div className="w-full max-w-md">
      ...
      <div className="bg-white dark:bg-slate-800 rounded-2xl shadow-xl border border-slate-200 dark:border-slate-700 p-8">
        ...
        {(state.error || error) && (
          <div className="mt-4">
            <FormError 
              message={state.error || (error === 'OAuthAccountNotLinked' 
                ? 'Ten email jest już powiązany z innym kontem.' 
